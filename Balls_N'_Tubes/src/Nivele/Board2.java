...
public class Board2 extends JPanel implements ActionListener, MouseListener {
    ...
    final static int TUBE_AMOUNT = 6;
    ...
    public void paintTube(Graphics g, Dimension d) {
        ...
        for (int level = 0; level < 2; level++) {
            ...
            if (tubeWidth == -1) {
                tubeWidth = d.width * 2 / (tubeInLvl * 7 + 1);
