...
public class Board5 extends JPanel implements ActionListener, MouseListener {
    ...
    final static int TUBE_AMOUNT = 9;
    final static int EMPTY_TUBE_AMOUNT = 4;
    boolean win;
    ...
    public void paintTube(Graphics g, Dimension d) {
        ...
        for (int level = 0; level < 2; level++) {
            ...
            if (tubeWidth == -1) {
                tubeWidth = d.width / (tubeInLvl * 2 + 3);
